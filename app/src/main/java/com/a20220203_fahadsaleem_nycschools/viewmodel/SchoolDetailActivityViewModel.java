...
public class SchoolDetailActivityViewModel extends ViewModel {
    ...
    private final NycHighSchoolRepository nycHighSchoolRepository = new NycHighSchoolRepositoryImp();
    ...
    public SchoolDetailActivityViewModel(String dbn) {
        getSchoolDetail(dbn);
    }

    private void getSchoolDetail(String dbn) {
